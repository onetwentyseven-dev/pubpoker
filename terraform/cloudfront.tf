...
# resource "aws_cloudfront_distribution" "play" {
#   origin {
#     domain_name = aws_s3_bucket.play.bucket_regional_domain_name
#     origin_id   = aws_s3_bucket.play.id
...
#     allowed_methods  = ["GET", "HEAD", "OPTIONS"]
#     cached_methods   = ["GET", "HEAD"]
#     target_origin_id = aws_s3_bucket.play.id
